from usvisa.constants import DATA_VALIDATION_DRIFT_REPORT_DIR
...
class DataValidationConfig:
    ...
    drift_report_page_file_path: str = os.path.join(data_validation_dir, DATA_VALIDATION_DRIFT_REPORT_DIR, DATA_VALIDATION_DRIFT_REPORT_PAGE_FILE_NAME)
...
class ModelTrainerConfig:
    ...
    expected_accuracy: float = MODEL_TRAINER_EXPECTED_MODEL_ACCURACY
